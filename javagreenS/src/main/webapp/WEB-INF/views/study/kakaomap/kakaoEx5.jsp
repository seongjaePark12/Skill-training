...
<head>
  ...
  <script>
    ...
    function addressSearch() {
    	...
    	location.href = "${ctp}/study/kakaoEx5?address="+address;
    }
  </script>
...
<p><br/></p>
<div class="container">
  <h2>지명으로 위치검색후 위도/경도 알아내어 등록하기(키워드(주소명)로 장소 검색)</h2>
  <hr/>
	<p>주소입력 :
  ...
  <hr/>
	...
	<script>
		...
		// 지역선택하여 화면에 로딩된 창에서 지도 클릭해서 위도/경도 알아내고 지명을 입력받은뒤, DB에 저장하기위한 준비....
		// 지도를 표시할 div와  지도 옵션으로  지도를 생성합니다
		//var map = new kakao.maps.Map(mapContainer, mapOption); 
